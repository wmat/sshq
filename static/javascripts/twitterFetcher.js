    ...
    callback: function(data) {
      ...
      while(n < x) {
        ...
        if (showInteractionLinks) {
          //op += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + tids[n] + '" class="twitter_reply_icon">Reply</a>' +
          //    '<a href="https://twitter.com/intent/retweet?tweet_id=' + tids[n] + '" class="twitter_retweet_icon">Retweet</a>' +
          //    '<a href="https://twitter.com/intent/favorite?tweet_id=' + tids[n] + '" class="twitter_fav_icon">Favorite</a></p>';
          op += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + tids[n] + '" class="twitter-share">Reply</a>' +
              '<a href="https://twitter.com/intent/retweet?tweet_id=' + tids[n] + '" class="twitter-share">Retweet</a>' +
              '<a href="https://twitter.com/intent/favorite?tweet_id=' + tids[n] + '" class="twitter-share">Favorite</a></p>';
        }
